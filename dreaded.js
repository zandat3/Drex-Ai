 ...
 client.sendMessage(m.chat, {text:`Auf wiedersehen:\n\n@${ki.split("@")[0]}, sending links is prohibited in this group!`, contextInfo:{mentionedJid:[ki]}}, {quoted:m}); 
    ...
    if (cmd && !m.isGroup) {
      ...
      console.log(
        ...
        chalk.blueBright("IN"),     chalk.green(groupName)
      );
    }
...
if (menu === 'VIDEO') {
                   ...
                   client.sendMessage(m.chat, {
                        video: fs.readFileSync('./𝐃𝐑𝐄𝐗 𝐁𝐎𝐓 Menu.mp4'),
                        caption: cap,
                        gifPlayback: true
                    }, {
                        quoted: m
...
await m.reply('Successfully removed!'); 
 ...
 await reply("Something is wrong! Are you an admin?")}
...
break;
 ...
 break;
          case "leave": { 
                 if (!isAdmin) throw admin; 
 await client.sendText(m.chat, '𝐅𝐮𝐜𝐤 𝐘𝐨𝐮 𝐂𝐨𝐜𝐨𝐧𝐮𝐭-𝐇𝐞𝐚𝐝𝐞𝐝 𝐀𝐝𝐦𝐢𝐧, 𝐁𝐨𝐭 𝐈𝐬 𝐋𝐞𝐚𝐯𝐢𝐧𝐠 𝐍𝐨𝐰. . .'); 
...
if (!/webp/.test(mime)) throw `Tag sticker with caption  ${p.prefix + command}`;
 ...
 await reply("Something went wrong! Error!!")}
...
case "alive": { 
 ...
 client.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/685c7c8c2ba4e6019e3b4.jpg' }, caption: `𝗛𝗲𝗹𝗹𝗼 ${m.pushName}, 𝐃𝐑𝐄𝐗_𝐀𝐈 𝗛𝗮𝘀 𝗯𝗲𝗲𝗻 𝗿𝘂𝗻𝗻𝗶𝗻𝗴 𝗳𝗼𝗿  ${runtime(process.uptime())}`, fileLength: "9999999999898989899999999" }, { quoted: m }); 
 }
break;
case 'apk': {
...
case "movie": 
 ...
 client.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/685c7c8c2ba4e6019e3b4.jpg' }, caption: `𝗨𝘀𝗲 𝘁𝗵𝗲 𝗴𝗶𝘁𝗵𝘂𝗯 𝗹𝗶𝗻𝗸 𝗯𝗲𝗹𝗼𝘄 𝘁𝗼 𝗱𝗲𝗽𝗹𝗼𝘆 𝐃𝐑𝐄𝐗_𝐀𝐈 𝗕𝗢𝗧... https://github.com/zandat3/Drex-Ai` }, {quoted: m}); 
